...
#SBATCH --output=./DeterministicBezierEncoder/MultiBezierModels/FixedCP/dataset_generation.out
#################
# a file for errors from the job
#SBATCH --error=./DeterministicBezierEncoder/MultiBezierModels/FixedCP/dataset_generation.err
#################
...
CODE="python -u DeterministicBezierEncoder/MultiBezierModels/FixedCP/dataset_generation.py"
