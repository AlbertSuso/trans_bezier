...
#SBATCH --output=./DeterministicBezierEncoder/MultiBezierModels/FixedCP/transformer_bezier.out
#################
# a file for errors from the job
#SBATCH --error=./DeterministicBezierEncoder/MultiBezierModels/FixedCP/transformer_bezier.err
#################
...
. DeterministicBezierEncoder/MultiBezierModels/FixedCP/scripts/experiments.sh

#################
# Prepare the experiment to run
CODE="python -u main.py --num_experiment $1 --new_model $new_model --num_transformer_layers $num_transformer_layers --num_control_points $num_control_points --max_beziers $max_beziers --transformer_encoder $trans_encoder --batch_size $batch_size --num_epochs $num_epochs --learning_rate $learning_rate"
