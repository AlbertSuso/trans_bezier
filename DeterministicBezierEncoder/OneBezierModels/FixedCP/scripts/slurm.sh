...
CODE="python -u main.py --num_experiment $1 --num_transformer_layers $num_transformer_layers --num_control_points $num_control_points --transformer_encoder $trans_encoder --batch_size $batch_size --num_epochs $num_epochs --learning_rate $learning_rate"
