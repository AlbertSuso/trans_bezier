...
"""LOADING DATASET"""
images = torch.load(os.path.join(basedir, "Datasets/OneBezierDatasets/Training/images/fixedCP"+str(num_control_points)))
sequences = torch.load(os.path.join(basedir, "Datasets/OneBezierDatasets/Training/sequences/fixedCP"+str(num_control_points)))
