...
#SBATCH --output=./ProbabilisticBezierEncoder/OneBezierModels/MultiCP2/dataset_generation.out
#################
# a file for errors from the job
#SBATCH --error=./ProbabilisticBezierEncoder/OneBezierModels/MultiCP2/dataset_generation.err
#################
...
CODE="python -u ProbabilisticBezierEncoder/OneBezierModels/MultiCP2/dataset_generation.py"
