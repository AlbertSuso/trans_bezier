...
#SBATCH --output=./ProbabilisticBezierEncoder/OneBezierModels/MultiCP/dataset_generation.out
#################
# a file for errors from the job
#SBATCH --error=./ProbabilisticBezierEncoder/OneBezierModels/MultiCP/dataset_generation.err
#################
...
CODE="python -u ProbabilisticBezierEncoder/OneBezierModels/MultiCP/dataset_generation.py"
