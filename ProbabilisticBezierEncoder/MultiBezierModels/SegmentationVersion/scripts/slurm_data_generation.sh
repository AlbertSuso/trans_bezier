...
#SBATCH --output=./ProbabilisticBezierEncoder/MultiBezierModels/SegmentationVersion/dataset_generation.out
#################
# a file for errors from the job
#SBATCH --error=./ProbabilisticBezierEncoder/MultiBezierModels/SegmentationVersion/dataset_generation.err
#################
