...
def generate1bezier(im_size=64, batch_size=64, max_beziers = 2, num_control_points=3, resolution=150, device='cuda'):
    ...
    return images, tgt_seq, tgt_padding_mask, num_bezier_curves
...
if __name__ == '__main__':
    ...
    for num_cp in [3, 4, 5, 6]:
        im_size = 64
        im, seq, tgt_padding_mask, num_beziers = generate1bezier(im_size=im_size, batch_size=50000, max_beziers=max_beziers, num_control_points=num_cp, device='cuda')
        im = im.to('cpu')
        seq = seq.to('cpu')
        tgt_padding_mask = tgt_padding_mask.to('cpu')
        torch.save(im, basedir+"/Datasets/MultiBezierDatasets/Training/images/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))
        torch.save(seq, basedir+"/Datasets/MultiBezierDatasets/Training/sequences/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))
        torch.save(tgt_padding_mask, basedir+"/Datasets/MultiBezierDatasets/Training/padding_masks/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))
        torch.save(num_beziers, basedir+"/Datasets/MultiBezierDatasets/Training/num_beziers/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))

        im, seq, tgt_padding_mask, num_beziers =generate1bezier(im_size=im_size, batch_size=10000, max_beziers=max_beziers, num_control_points=num_cp, device='cuda')
        im = im.to('cpu')
        seq = seq.to('cpu')
        tgt_padding_mask = tgt_padding_mask.to('cpu')
        torch.save(im, basedir + "/Datasets/MultiBezierDatasets/Test/images/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))
        torch.save(seq, basedir + "/Datasets/MultiBezierDatasets/Test/sequences/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))
        torch.save(tgt_padding_mask, basedir + "/Datasets/MultiBezierDatasets/Test/padding_masks/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))
        torch.save(num_beziers, basedir+"/Datasets/MultiBezierDatasets/Test/num_beziers/fixedCP"+str(num_cp)+"_maxBeziers"+str(max_beziers)+"imSize"+str(im_size))
