...
#SBATCH --output=./ProbabilisticBezierEncoder/MultiBezierModels/FixedCP/dataset_generation.out
#################
# a file for errors from the job
#SBATCH --error=./ProbabilisticBezierEncoder/MultiBezierModels/FixedCP/dataset_generation.err
#################
